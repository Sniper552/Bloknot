...
namespace Bloknot.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        private object content;
        private NotepadViewModel notepadView;
        private FileLOpenViewModel fileListOpenView;
        private FileLSaveViewModel fileListSaveView;

        public MainWindowViewModel()
        {
            notepadView = new NotepadViewModel();
            notepadView.Text = "";
            fileListOpenView = new FileLOpenViewModel();
            fileListSaveView = new FileLSaveViewModel();
            Content = notepadView;
            Observable.Merge(
